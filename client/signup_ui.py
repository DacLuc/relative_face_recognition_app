...
#         self.info_account.setGeometry(QtCore.QRect(70, 70, 471, 291))
#         font = QtGui.QFont()
...
#         self.title_label.setGeometry(QtCore.QRect(140, 20, 344, 27))
#         font = QtGui.QFont()
...
#         self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(220, 370, 169, 31))
...
#         self.apply_button.clicked.connect(self.check_signup)
...
#             _translate(
#                 "Sign_Up_Page",
#                 '<html><head/><body><p><span style=" font-weight:700;">TÊN ĐĂNG KÝ</span></p></body></html>',
#             )
#         )
#         self.label_2.setText(
#             _translate(
#                 "Sign_Up_Page", "<html><head/><body><p>EMAIL ĐĂNG KÝ</p></body></html>"
#             )
#         )
#         self.label_4.setText(
#             _translate(
#                 "Sign_Up_Page",
#                 '<html><head/><body><p><span style=" font-weight:700;">NHẬP MẬT KHẨU</span></p></body></html>',
#             )
#         )
...
class Ui_Sign_Up_Page(object):
    ...
    def setupUi(self, Sign_Up_Page):
        ...
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(
            parent=self.info_account)
        self.verticalLayoutWidget_2.setGeometry(
            QtCore.QRect(220, 60, 201, 171))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        ...
        self.label_6.setObjectName("label_6")
        self.horizontalLayout.addWidget(self.label_6)
        self.check_robot = QtWidgets.QCheckBox(
    ...
    def retranslateUi(self, Sign_Up_Page):
        ...
        self.account_name.setPlaceholderText(
            _translate("Sign_Up_Page", "Ten Dang Ky"))
        self.account_email.setPlaceholderText(
            _translate("Sign_Up_Page", "Tai khoan Email")
        )
        self.account_password.setPlaceholderText(
            _translate("Sign_Up_Page", "Password"))
        self.confirm_password.setPlaceholderText(
            _translate("Sign_Up_Page", "Confirm Password")
        )
        self.label_6.setText(
