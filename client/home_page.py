...
class Ui_Home_Page(object):
    def setupUi(self, Home_Page):
        ...
        self.title_label.setGeometry(QtCore.QRect(70, 10, 344, 27))
        font = QtGui.QFont()
        ...
        self.home_page_box.setGeometry(QtCore.QRect(60, 60, 361, 241))
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.exit_button.clicked.connect(Home_Page.close)
