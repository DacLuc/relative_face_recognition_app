...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Specific_Task):
        ...
        self.label.setText(_translate("Specific_Task", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">MENU</span></p></body></html>"))
        self.pushButton.setText(_translate("Specific_Task", "NHẬP THÔNG TIN CÁ NHÂN "))
        self.pushButton_2.setText(_translate("Specific_Task", "NHẬP THÔNG TIN TÌM KIẾM"))
